        ...
        <div class="panel panel-primary">
            ...
            <form action="/products/{{ $product->id }}" method="POST" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="product_name" name="product_name" class="form-control" value="{{ $product->product_name }}" autocomplete="off" />
                ...
                <div class="form-group">
                    ...
                    <textarea name="product_description" id="product_description" class="form-control" rows="5">{{ $product->product_description }}</textarea>
                    <span class="text-danger">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="product_quantity" id="product_quantity" class="form-control" value="{{ $product->product_quantity }}" step="0.5" min="0" />
                            <span class="text-danger">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Price</label>
                            <input type="number" name="product_price" id="product_price" class="form-control" value="{{ $product->product_price }}" step="0.5" min="0" />
                            <span class="text-danger">
                                @error('product_price')
                                    <i class="glyphicon glyphicon-exclamation-sign"></i>
                                    {{ $message }}
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Tax</label>
                            <input type="number" name="product_tax" id="product_tax" class="form-control" value="{{ $product->product_tax }}" step="0.5" min="0" />
                            <span class="text-danger">
                                @error('product_tax')
                                    <i class="glyphicon glyphicon-exclamation-sign"></i>
                                    {{ $message }}
                ...
                <div class="form-group">
                    <div class="checkbox">
                        <input type="checkbox" id="product_status" @if ($product->product_status == 1) {{ "checked" }}  @endif />
                    </div>
                    <input type="hidden" name="product_status" id="hiddenProductStatus" value="@if($product->product_status == 1){{"1"}}@else{{"0"}}@endif" />
                </div>
                
                <button type="submit" name="btnAddNewProduct" class="btn btn-primary">Edit Product</button>
    ...
    $(function() {
        ...
        */    
        ...
        $("#category_id").on("change", function() {
            ...
            $.ajax({
                url: "{{ URL::to('get_brands') }}/" + category_id,
                type: "GET",
                dataType: "json",
                success:function(data) {
                    $("#brand_id").empty();
